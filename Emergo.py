...
if situation == "Earthquake":
    st.video("https://youtu.be/hWSu4l1RxLg?si=BNzAOlnkeZ4MbRuA")
elif situation == "Flood":
    st.video("https://www.youtube.com/watch?v=rV1iqRD9EKY")
elif situation == "Landslide":
    st.video("https://www.youtube.com/watch?v=9j_StYqR_Pg")
elif situation == "Tornado":
    st.video("https://www.youtube.com/watch?v=wcTdLnrxznM")
elif situation == "Terrorist Attack":
    st.video("https://www.youtube.com/watch?v=hs2prs9xVk8")
elif situation == "House Fire":
    st.video("https://www.youtube.com/watch?v=Xgc90CoJbDI")
